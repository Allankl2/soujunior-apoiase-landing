...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **TC-01** | Hero Section | Exibição *Above the Fold* | 1. Carregar a página em mobile (375px/667px).<br>2. Verificar elementos sem rolar a tela. | O título principal e o botão "Apoiar a Sou Junior" ficam visíveis sem rolar a página. | [X] Pass<br>[ ] Fail |
...
| **TC-11** | Performance | Tempo de Carregamento 4G | 1. Abrir Chrome DevTools (Aba *Network*).<br>2. Emular rede 4G e carregar. | A página finaliza o carregamento completo em menos de 3,0 segundos. | [ ] Pass<br>[X] Fail |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **TC-01** | Hero Section | Exibição *Above the Fold*[cite: 1] | 1. Carregar a página em mobile (360px/375px)[cite: 1].<br>2. Verificar elementos sem rolar a tela[cite: 1]. | O título principal e o botão "Doar agora" ficam visíveis sem rolar a página[cite: 1]. | [ ] Pass<br>[ ] Fail |
...
| **TC-11** | Performance | Tempo de Carregamento 4G[cite: 1] | 1. Abrir Chrome DevTools (Aba *Network*).<br>2. Emular rede 4G e carregar[cite: 1]. | A página finaliza o carregamento completo em menos de 3,0 segundos[cite: 1]. | [ ] Pass<br>[ ] Fail |